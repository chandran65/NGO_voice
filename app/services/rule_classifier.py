...
EXPLICIT_RULE_PATTERNS = {
    ...
    "PAYMENT_LINK": [
        "gpay link", "upi link", "payment link", "send upi link", "send payment link", "how to send money", "how do i pay", "how to pay",
        ...
        "எப்படி பணம் அனுப்புவது", "பணம் எப்படி அனுப்புறது", "எப்படிங்க நம்பர் அனுப்புவது பணம் அனுப்புவது",
        "எப்படி பணம் செலுத்துவது", "பணம் எப்படி செலுத்தணும்", "எப்படி பணம் கட்டணும்", "பணம் எப்படி தரணும்",
        "பணம் அனுப்பணும்", "பணம் அனுப்புறது"
    ],
    "TAX_BENEFITS": [
    ...
    "DONATION_USAGE": [
        "donation utilization", "where does money go", "how funds spent", "how is donation used", "how can i help", "how to donate",
        ...
        "இல்லைங்க என்னோட சைடுல இருந்து உங்களுக்கு என்ன உதவி பண்ணனும்", "உங்களுக்கு என்ன உதவி பண்ணனும்",
        "என்ன உதவி பண்ணனும்", "உதவி பண்ணனும்", "நான் என்ன பண்ணனும்", "என்னோட சைடுல இருந்து", "எப்படி உதவி பண்றது"
    ],
    "SPONSOR_CHILD": [
    ...
    "NUMBER_SOURCE": [
        "where did you get my number", "who gave my contact", "how you got my phone", "how did you get my number",
        "என் போன் நம்பர் எப்படி உங்களுக்கு கிடைச்சது", "என் நம்பர் எப்படி கிடைச்சுச்சு", "யாரு என் நம்பர் கொடுத்தா",
        "என்னோட நம்பர் உங்களுக்கு எப்படி கிடைச்சது", "என்னோட நம்பர் எப்படி கிடைச்சது", "நம்பர் உங்களுக்கு எப்படி கிடைச்சது",
        "எப்படி கிடைச்சது", "நம்பர் எப்படி கிடைச்சது", "எப்படி என்னோட நம்பர் கிடைச்சது", "நம்பர் எப்டி கிடைச்சது",
        "எப்படிங்க என்னோட நம்பர் உங்களுக்கு கிடைச்சது"
    ],
    "ABOUT_HOME": [

...
INTENTS_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_REQUEST": {
        ...
        "phrases_ta": [
            ...
            "ஹியூமன் சப்போர்ட்", "ஆபிசர் கிட்ட மாத்துங்க", "பிரதிநிதி கூட பேசணும்", "நேரடியா பேசணும்"
        ]
    },
    "ABOUT_HOME": {
        "code": "ABOUT_HOME",
        ...
        "phrases_ta": [
            "இல்லம் பற்றி", "அறக்கட்டளை பற்றி", "அறக்கட்டளை பத்தி", "உங்களோட அறக்கட்டளை பத்தி சொல்லுங்க",
